...
${nuget_cmd} install src/com.whatsapi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/com.whatsapi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/com.whatsapi.dll \
-recurse:'src/com.whatsapi/*.cs' \
-doc:bin/com.whatsapi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/com.whatsapi.dll was created successfully"
fi
