...
${nuget_cmd} install src/WhatsAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/WhatsAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/WhatsAPI.dll \
-recurse:'src/WhatsAPI/*.cs' \
-doc:bin/WhatsAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/WhatsAPI.dll was created successfully"
fi
