...
namespace WhatsAPI.models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ButtonMessagePayload :  IEquatable<ButtonMessagePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ButtonMessagePayload" /> class.
        /// </summary>
        ...
        public ButtonMessagePayload(List<ReplyButton> buttons = default(List<ReplyButton>), string footerText = default(string), string headerText = default(string), string text = default(string), string to = default(string))
        {
        ...
        {
            return this.Equals(input as ButtonMessagePayload);
        }

        /// <summary>
        /// Returns true if ButtonMessagePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ButtonMessagePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ButtonMessagePayload input)
        {
            if (input == null)
                return false;
