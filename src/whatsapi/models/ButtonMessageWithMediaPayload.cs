...
namespace WhatsAPI.models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ButtonMessageWithMediaPayload :  IEquatable<ButtonMessageWithMediaPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ButtonMessageWithMediaPayload" /> class.
        /// </summary>
        ...
        public ButtonMessageWithMediaPayload(List<ReplyButton> buttons = default(List<ReplyButton>), string footerText = default(string), FileUpload mediaData = default(FileUpload), string text = default(string), string to = default(string))
        {
        ...
        {
            return this.Equals(input as ButtonMessageWithMediaPayload);
        }

        /// <summary>
        /// Returns true if ButtonMessageWithMediaPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ButtonMessageWithMediaPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ButtonMessageWithMediaPayload input)
        {
            if (input == null)
                return false;
