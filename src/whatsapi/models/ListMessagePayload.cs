...
namespace WhatsAPI.models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListMessagePayload :  IEquatable<ListMessagePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessagePayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListMessagePayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessagePayload" /> class.
        /// </summary>
        ...
        public ListMessagePayload(string buttonText = default(string), string description = default(string), bool multiSelect = default(bool), List<ListSection> sections = default(List<ListSection>), string text = default(string), string title = default(string), string to = default(string))
        {
            // to ensure "sections" is required (not null)
            if (sections == null)
            {
                throw new InvalidDataException("sections is a required property for ListMessagePayload and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for ListMessagePayload and cannot be null");
            }
            else
            {
                this.To = to;
        ...
        {
            return this.Equals(input as ListMessagePayload);
        }

        /// <summary>
        /// Returns true if ListMessagePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ListMessagePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListMessagePayload input)
        {
            if (input == null)
                return false;
