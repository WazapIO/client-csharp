...
namespace WhatsAPI.models
{
    ...
    public partial class ListItem :  IEquatable<ListItem>, IValidatableObject
    {
        ...
        public ListItem(string description = default(string), string rowId = default(string), string title = default(string))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for ListItem and cannot be null");
            }
            else
            {
                this.Title = title;
