...
namespace WhatsAPI.models
{
    ...
    public partial class UploadMediaRequest :  IEquatable<UploadMediaRequest>, IValidatableObject
    {
        ...
        public UploadMediaRequest(System.IO.Stream file = default(System.IO.Stream))
        {
            // to ensure "file" is required (not null)
            if (file == null)
            {
                throw new InvalidDataException("file is a required property for UploadMediaRequest and cannot be null");
            }
            else
            {
                this.File = file;
