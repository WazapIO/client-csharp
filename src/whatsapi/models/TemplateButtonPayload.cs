...
namespace WhatsAPI.models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateButtonPayload :  IEquatable<TemplateButtonPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateButtonPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateButtonPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateButtonPayload" /> class.
        /// </summary>
        ...
        public TemplateButtonPayload(List<TemplateButton> buttons = default(List<TemplateButton>), string contentText = default(string), string footer = default(string), string header = default(string), string to = default(string))
        {
            // to ensure "buttons" is required (not null)
            if (buttons == null)
            {
                throw new InvalidDataException("buttons is a required property for TemplateButtonPayload and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for TemplateButtonPayload and cannot be null");
            }
            else
            {
                this.To = to;
        ...
        {
            return this.Equals(input as TemplateButtonPayload);
        }

        /// <summary>
        /// Returns true if TemplateButtonPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateButtonPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateButtonPayload input)
        {
            if (input == null)
                return false;
