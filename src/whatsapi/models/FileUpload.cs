...
namespace WhatsAPI.models
{
    ...
    public partial class FileUpload :  IEquatable<FileUpload>, IValidatableObject
    {
        ...
        public FileUpload(string directPath = default(string), List<int> fileEncSha256 = default(List<int>), int fileLength = default(int), List<int> fileSha256 = default(List<int>), List<int> mediaKey = default(List<int>), string mimeType = default(string), string url = default(string))
        {
            // to ensure "directPath" is required (not null)
            if (directPath == null)
            {
                throw new InvalidDataException("directPath is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fileEncSha256 is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            if (fileLength == null)
            {
                throw new InvalidDataException("fileLength is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            if (fileSha256 == null)
            {
                throw new InvalidDataException("fileSha256 is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            if (mediaKey == null)
            {
                throw new InvalidDataException("mediaKey is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            if (mimeType == null)
            {
                throw new InvalidDataException("mimeType is a required property for FileUpload and cannot be null");
            }
            else
            {
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for FileUpload and cannot be null");
            }
            else
            {
                this.Url = url;
